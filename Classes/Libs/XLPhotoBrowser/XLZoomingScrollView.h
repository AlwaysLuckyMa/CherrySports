...
//@protocol SetLoadNumDelete <NSObject> //代理
//
//
//
//@end
...
//@property (nonatomic, weak)id<SetLoadNumDelete>Delegate; //代理
/**
...
@property (nonatomic,copy) void(^downLoad_Block)(CGFloat num);
@property (nonatomic,copy) void(^Al_downloaded_Block)(CGFloat alNum);
