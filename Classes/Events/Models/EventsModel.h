...
@interface EventsModel : BaseModel

/** dd:hh:mm:ss*/
@property (nonatomic, copy) NSString *countDownTime;
/** 毫秒*/
@property (nonatomic, assign) NSTimeInterval countDownMilli;
/** 记录结束时间*/
...
@property (nonatomic, copy) NSString * tOrderId;

@property (nonatomic, copy) NSString * tEnterUserId;
/** 是否多人报名 0.是*/
@property (nonatomic, copy) NSString * isManyPeopleEnter;
