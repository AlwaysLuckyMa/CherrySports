...
@interface BindingCell ()<UITextFieldDelegate>
...
- (void)createSubViews
{
    ...
    [phoneIcon mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.equalTo(redLine.mas_bottom).offset(-14.5);
    }];
    ...
    _phoneFeild.font = [UIFont systemFontOfSize:15];
    ...
    [_phoneFeild mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.equalTo(redLine.mas_top).offset(-8);
    ...
    [lockIcon mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_equalTo(14);
        make.bottom.equalTo(redLineOne.mas_bottom).offset(-14.5);
    }];
    ...
    [_verificationCode mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(redLine.mas_bottom).offset(4);
    ...
    [_countDownBtn setImage:[UIImage imageNamed:@"get_cation_gray"] forState:UIControlStateNormal];
    ...
    [_countDownBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerY.equalTo(_verificationCode).offset(1);
...
//        _countNum.backgroundColor = [UIColor yellowColor];
    ...
    UILabel *tishiLabel = [AppTools createLabelText:@"*为了您更便捷的进行赛事报名，请输入手机号进行绑定" Color:TEXT_COLOR_RED Font:12 TextAlignment:NSTextAlignmentLeft];
    ...
    [tishiLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.right.equalTo(redLineOne);
...
- (void)textFieldDidChange:(UITextField *)theTextFeild
{
    ...
    if (theTextFeild == _phoneFeild) {
        if (theTextFeild.text.length == 11 && _countNum.text.length == 0) {
            [_countDownBtn setImage:[UIImage imageNamed:@"get_cation_red"] forState:UIControlStateNormal];
            [_countDownBtn setImage:[UIImage imageNamed:@"get_cation_red"] forState:UIControlStateHighlighted];
...
- (void)countDown
{
    ...
    //设置倒计时显示的时间
    [_countDownBtn setImage:[UIImage imageNamed:@"get_Down"] forState:UIControlStateNormal];
